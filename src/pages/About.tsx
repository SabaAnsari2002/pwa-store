                    ...
                    <div className="flex flex-col md:flex-row items-center">
                        <div className="md:w-1/2 mb-10 md:mb-0">
                            ...
                            <p className="text-lg text-gray-300 mb-8">
                                پروژه <span className="font-bold text-white">اسم پروژه بیچارم</span> با هدف ایجاد بستری امن، سریع و آسان برای خرید و فروش آنلاین راه‌اندازی شده است. ما معتقدیم که خرید اینترنتی باید ساده، مطمئن و لذت‌بخش باشد.
                            </p>
