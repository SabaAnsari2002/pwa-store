...
const initialPostsData: BlogPost[] = [
  {
    id: 1,
    title: "معرفی پروژه جوجک و اهداف آن",
    body: `
      <p class="mb-4">در این مقاله با اهداف و ویژگی‌های پروژه جوجک آشنا می‌شوید و دلیل انتخاب این نام را خواهید فهمید.</p>
      <p class="mb-4">پروژه جوجک با هدف ایجاد بستری امن و آسان برای خرید و فروش آنلاین راه‌اندازی شده است. ما اعتقاد داریم که تجربه خرید آنلاین می‌تواند ساده‌تر و لذت‌بخش‌تر باشد.</p>
      <h3 class="text-xl font-bold my-4 text-[#1e40af]">چرا نام جوجک؟</h3>
      <p class="mb-4">جوجک به معنی پرنده کوچک و چابک است که نمادی از سرعت، چابکی و دسترسی آسان ما به نیازهای مشتریان است.</p>
      <p class="mb-4">ما در جوجک به دنبال ایجاد تجربه‌ای متفاوت از خرید آنلاین هستیم که در آن کاربران احساس راحتی و امنیت داشته باشند.</p>
    `,
    date: "۱۴۰۲/۰۱/۱۵",
    category: "معرفی",
    author: "تیم جوجک",
