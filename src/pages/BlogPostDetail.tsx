...
const postsData: BlogPost[] = [
    {
        ...
        body: `
      <p>در این مقاله با اهداف و ویژگی‌های پروژه جوجیک آشنا می‌شوید و دلیل انتخاب این نام را خواهید فهمید.</p>
      <p>پروژه جوجیک با هدف ایجاد بستری امن و آسان برای خرید و فروش آنلاین راه‌اندازی شده است...</p>
    `,
        date: "۱۴۰۲/۰۱/۱۵",
        category: "معرفی",
    },
