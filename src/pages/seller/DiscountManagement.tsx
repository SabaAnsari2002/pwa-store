...
const DiscountManagement: React.FC = () => {
  ...
  const [newDiscount, setNewDiscount] = useState<Omit<Discount, "id" | "created_at" | "seller">>({
    title: "",
    code: "",
    description: "",
    percentage: 0,
  ...
  const fetchDiscounts = async () => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:8000/api/users/discount/", {
        headers: {
  ...
  const handleDeleteDiscount = async (id: number) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8000/api/users/discount/${id}/`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${currentToken}`,
        },
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8000/api/users/discount/${editDiscountId}/`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${currentToken}`,
  ...
  const filteredDiscounts = discounts.filter(discount =>
    ...
    const calculateRemainingTime = (createdAt: string) => {
        try {
            ...
            if (now > expiryDate) return "منقضی شده";
            ...
            if (isNaN(days) || isNaN(hours) || isNaN(minutes)) return "نامشخص";
      ...
      <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full p-3.5 border bg-white border-gray-200 rounded-lg focus:ring-2 focus:ring-[#3b82f6] focus:border-transparent transition-all"
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full p-3.5 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#3b82f6] focus:border-transparent transition-all"
                  >
                    <option value="false">غیر فعال</option>
                    <option value="true">فعال</option>
                  </select>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-6 mb-8">
          ...
          <div className="relative">
            <input
              type="text"
              placeholder="جستجوی تخفیف‌ها بر اساس عنوان، کد یا توضیحات..."
              value={searchQuery}
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">زمان باقیمانده</th>
                      ...
                      <tr key={discount.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <div className="flex items-center">
                            ...
                            {calculateRemainingTime(discount.created_at)}
                          </div>
                        </td>
