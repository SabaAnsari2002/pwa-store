                                ...
                                {selectedTicket.replies.map((reply) => (
                                    <div key={reply.id} className={`${reply.is_staff_reply ? 'pr-6' : 'pl-6'}`}>
                                        <div className={`flex items-center justify-between mb-3 ${reply.is_staff_reply ? 'flex-row-reverse' : ''}`}>
                                            <div className="flex items-center">
                                                <div className={`${reply.is_staff_reply ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'} w-8 h-8 rounded-full flex items-center justify-center mr-2`}>
                                                    {reply.user.is_staff ? (
                                                        <FaUserShield size={16} />
                                                    ) : (
                                                        <FaUser size={16} />
                                            ...
                                            <span className={`text-xs px-2 py-1 rounded-full ${reply.is_staff_reply ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'}`}>
